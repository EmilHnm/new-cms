                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <textarea name="description" id="textarea" class="form-control" style="min-height:100px" required="" placeholder="Enter Description" aria-invalid="false">{{ old('description') }}</textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <img src="{{asset('/upload/no_image.jpg')}}" alt="" id="thumd_preview" srcset="" style="aspect-ratio: 1 / 1; width: 100px; height:auto; object-fit:contain; margin: auto">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="active" checked type="radio" value="1" class="with-gap" id="active">
                                                    <label for="active" >Active</label>
                                                    <input name="active" type="radio" value="0" id="inactive" class="with-gap">
